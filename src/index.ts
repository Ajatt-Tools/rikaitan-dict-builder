...
// Types
import { DictionaryIndexType } from './types/rikaitan/dictionaryindex';
import {
  DictionaryOptions,
  DictionaryStats,
  Counters,
...
import {
  ...
  TermInformation,
} from './types/rikaitan/termbank';
import {
  DictionaryTermMetaBankV3,
  TermMetaEntryType,
} from './types/rikaitan/termbankmeta';
import {
  DictionaryKanjiBankV3,
  KanjiInformation,
  KanjiStats,
} from './types/rikaitan/kanjibank';
import {
  DictionaryKanjiMetaBankV3,
  KanjiCharacterMetadata,
} from './types/rikaitan/kanjibankmeta';
import {
  DictionaryTagBankV3,
  TagInformation,
  TagOption,
} from './types/rikaitan/tagbank';
