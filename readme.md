# Rikaitan Dictionary Builder

[![npm](https://img.shields.io/npm/v/rikaitan-dict-builder?style=for-the-badge)](https://www.npmjs.com/package/rikaitan-dict-builder)

This is a library for building dictionaries for
[Rikaitan](https://github/Ajatt-Tools/rikaitan) (formerly Yomichan).

## Installation

```sh
npm install rikaitan-dict-builder
```

## Contributing

Please let me know if you find any bugs or have any feature requests. I'd love
to see this library be used to create more Rikaitan dictionaries, so if you do
...
- [example.js](./examples/example.js) - A simple example of how to use the
  library.
- [CC-CEDICT for Rikaitan](https://github.com/Ajatt-Tools/cc-cedict-rikaitan)
- [Wikipedia for Rikaitan](https://github.com/Ajatt-Tools/wikipedia-rikaitan)
- [VNDB To Rikaitan](https://github.com/asayake-b5/rikaitan-vndb) - A tool for
  creating Rikaitan dictionaries of visual novel character names from vndb.org.
- [words.hk for Rikaitan](https://github.com/Ajatt-Tools/wordshk-rikaitan)
- [Pixiv Encyclopedia for Rikaitan](https://github.com/Ajatt-Tools/pixiv-rikaitan)
- [Kanji de Go for Rikaitan/Anki](https://github.com/Ajatt-Tools/kanjidego-rikaitan-anki)

## Relevant Tools and Information

- [How to Make Rikaitan/Yomichan Dictionaries](https://github.com/Ajatt-Tools/yomichan-dictionaries/blob/master/how-to-make-yomichan-dictionaries.md)
- [RikaitanDic](https://github.com/hopto-dot/rikaitan-dic) - a similar package for
  creating Rikaitan dictionaries, but written in Python.

## Usage

- The `Dictionary` class represents a Rikaitan dictionary. You can add entries,
...
- The `DictionaryIndex`, `TermEntry`, and `KanjiEntry` classes represent some of
  the more complicated parts of a Rikaitan dictionary. You can create them and
...
- If using JS, you might want to set
  ...
  failing to validate against the Rikaitan schemas. However, I recommend using
  TypeScript.
- In particular, it might be a good idea to check out the
  [Rikaitan Schemas](https://github.com/Ajatt-Tools/yomichan-dictionaries/blob/master/how-to-make-yomichan-dictionaries.md#read-the-schemas)
...
- You can simply add a `styles.css` file using the `addFile()` method to add
  ...
  [Read more in the official docs](https://github.com/Ajatt-Tools/rikaitan/blob/main/docs/making-rikaitan-dictionaries.md#adding-custom-css).

### Dictionary Class

The `Dictionary` class represents a Rikaitan dictionary and is used to manage
...
```javascript
const { Dictionary } = require('rikaitan-dict-builder');
...
```javascript
const { DictionaryIndex } = require('rikaitan-dict-builder');

const index = new DictionaryIndex()
  .setTitle('Test Dictionary')
  .setRevision('1.0')
  .setAuthor('Marv')
  .setDescription('Test dictionary for rikaitan-dict-builder')
...
```javascript
const { TermEntry } = require('rikaitan-dict-builder');
...
const { KanjiEntry } = require('rikaitan-dict-builder');
